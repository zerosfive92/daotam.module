		...
		$wp_customize->add_control(
			new WP_Customize_Control(
				...
				'container_type', array(
					...
					'description' => __( "Choose between Bootstrap's container and container", 'bootstrapfast' ),
					...
					'choices'     => array(
						...
						'container' => __( 'Full width container', 'bootstrapfast' ),
					),
					'priority'    => '10',
				)
			)
...
function bootstrapfast_container_type_sanitize( $containertype ) {
	if ( ! in_array( $containertype, array( 'container', 'container' ), true ) ) {
